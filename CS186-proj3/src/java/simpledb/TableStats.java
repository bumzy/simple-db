...
public class TableStats {
    ...
    private Object[] histograms = null;
    ...
    public TableStats(int tableid, int ioCostPerPage) {
        ...
        this.heapFile = (HeapFile) Database.getCatalog().getDbFile(tableid);
        TupleDesc td = Database.getCatalog().getTupleDesc(tableid);
        int numFields = td.numFields();
        this.ioCostPerPage = ioCostPerPage;
        TransactionId tid = new TransactionId();
        DbFileIterator iter = this.heapFile.iterator(tid);
        ...
        try {
            ...
            while (iter.hasNext()) {
                ...
                for (int i = 0; i < numFields; i++) {
                    ...
                    if (t.equals(Type.INT_TYPE)) {
                        int v = ((IntField) f).getValue();
                        IntHistogram ih = (IntHistogram) this.histograms[i];
                        ih.addValue(v);
                    } else if (t.equals(Type.STRING_TYPE)) {
                        String v = ((StringField) f).getValue();
                        StringHistogram sh = (StringHistogram) this.histograms[i];
                        sh.addValue(v);
                    }
                }
            }
    ...
    public double estimateScanCost() {
        return 1.0 * this.heapFile.numPages() * this.ioCostPerPage;
    }
    ...
    public int estimateTableCardinality(double selectivityFactor) {
        return (int) Math.ceil(this.ntups * selectivityFactor);
    }
    ...
    public double estimateSelectivity(int field, Predicate.Op op, Field constant) {
        if (constant.getType().equals(Type.INT_TYPE)) {
            ...
            return sh.estimateSelectivity(op, v);
        }
        return 1.0;
    }
